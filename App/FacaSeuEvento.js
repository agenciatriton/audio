...
function FacaSeuEvento(props) {
  ...
  function TextoDentro2(props){
    ...
    return (
    <>
         <SafeAreaView style={[{justifyContent:'center',alignItems:'center', width:'100%', flex:1  }]}>
            ...
            <View style={{width:'100%', backgroundColor:"#FFF", justifyContent:'center',alignItems:'center', paddingTop:15}}>
               <View style={{width:'90%'}}>
            ...
            <View style={{width:'100%', backgroundColor:"#FFF", justifyContent:'center',alignItems:'center', paddingTop:15}}>
               <View style={{width:'90%'}}>
                <View style={{flexDirection:'row'}}>
                    ...
                    <View>
                    <ImageResize  source={require('../assets/ico_garden_cinza.png')} width={(Dimensions.get('window').width/100)*10} />
                    </View>
                </View>
                <View>
                  <View style={{ width:"90%", marginBottom:Dimensions.get('window').width/40,marginTop:Dimensions.get('window').width/40,}}>
            ...
            <View style={{width:'100%', backgroundColor:"#FFF", justifyContent:'center',alignItems:'center', paddingTop:15}}>
               <View style={{width:'90%'}}>
                <View style={{flexDirection:'row'}}>
                    ...
                    <View>
                    <ImageResize  source={require('../assets/ico_pavilion_cinza.png')} width={(Dimensions.get('window').width/100)*10} />
                    </View>
                </View>
                <View>
                  <View style={{ width:"90%", marginBottom:Dimensions.get('window').width/40,marginTop:Dimensions.get('window').width/40,}}>
            ...
            <View style={{width:'100%', backgroundColor:"#FFF", justifyContent:'center',alignItems:'center', paddingTop:15, paddingBottom:15}}>
              <View style={{width:'90%'}}>
              <View style={{flexDirection:'row'}}>

...
function ItensBanner(props) {
    ...
    <View key={props.item.id_tb_banner} style={{flex:1}}>
          ...
          <TouchableOpacity style={{zIndex:1}} onPress={()=>AbreProgramacao(props.item)} style={{width:Dimensions.get('window').width, height:Dimensions.get('window').width/1.3}}>
          {
          gray === true
          ?
          ...
          {props.item.c_adiado != ''?
          <View style={[Estilos.NovaData, {bottom:20}]}><Text style={[Estilos.NovaDataTexto]}>{props.item.c_adiado}</Text></View>
          :
          null
          }
          </View>
          ...
          null
            ...
            {/*<View style={{backgroundColor:'#ffffff', flex:1}}><Text>ssssss</Text></View> */}

       
          <TouchableOpacity  onPress={()=>AbreProgramacao(props.item)}  style={{backgroundColor:"#222222", justifyContent:"center", alignItems:'flex-start', flex:1, paddingLeft:Dimensions.get('window').width/15, paddingRight:Dimensions.get('window').width/15}}>
          <View style={{ flexDirection:"row", justifyContent:"flex-start", alignItems:'flex-start', }}>
                <View style={{justifyContent:"flex-start", alignItems:'flex-start'}}>
                    <Text style={[Estilos.DiaItensBanner,{}]}>{props.item.dia}</Text>
                </View>

                <View style={{marginLeft:5}}>
                    <Text style={[Estilos.MesItensBanner,{}]}>{props.item.mes} <TextoDiaSemana>{props.item.diasemana}</TextoDiaSemana></Text>
              ...
              <View style={{width:Dimensions.get('window').width/100*85, marginRight:10, paddingTop:5}}>
                <Text style={[Estilos.TituloBanner2x,{}]}>{props.item.c_titulo}</Text>
              </View>
          </TouchableOpacity>

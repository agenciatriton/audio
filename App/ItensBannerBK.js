...
function ItensBanner(props) {
    ...
    <View key={props.item.id_tb_banner} style={{flex:1}}>
        ...
        <View style={{position:"absolute", bottom:10, right:20, zIndex:1000,flex:1, flexDirection:'row'}}>
         


           <TouchableOpacity style={{marginRight:10}}><ImageResize source={require('../assets/twiter_branco.png')} width={Dimensions.get('window').width/12} 
            onPress={
              ()=>  Compartilhar(
                '',
                '',
           ...
           <TouchableOpacity><ImageResize source={require('../assets/facebook_branco.png')} width={Dimensions.get('window').width/12} 
            onPress={
              ()=>  Compartilhar(
                '',
                '',
        ...
        <View style={{position:"absolute", bottom:45, left:30, zIndex:1000,flex:1}}>
        <View style={{ flexDirection:"row", justifyContent:"flex-start", alignItems:'flex-start'}}>
            ...
            <View style={{width:Dimensions.get('window').width/100*85, marginRight:10, flex:1}}><Text style={[Estilos.TituloBanner]}>{props.item.c_titulo}</Text></View>
        </View>
   

          <TouchableOpacity style={{zIndex:1}} onPress={()=>AbreProgramacao(props.item)} style={{width:Dimensions.get('window').width, height:300}}>
          {
          gray === true
          ?
